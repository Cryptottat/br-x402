      ...
      children: [
        {
          ...
          title: 'Overview',
          subChildren: [
            { id: 'what-is-br-x402', title: 'What is GATEX402?' },
          ]
        },
        {
          id: 'core-concepts',
          title: 'Core Concepts',
          subChildren: [
            { id: 'br-x402-ecosystem', title: 'The GATEX402 Ecosystem' },
          ]
        },
        {
          id: 'getting-access',
          ...
          subChildren: [
            { id: 'accessing-br-x402-tools', title: 'Accessing GATEX402 Tools' },
          ]
        },
      ]
    },
          ...
          <section id="introduction" className="docs-section">
            ...
            <section id="overview" className="subsection">
              ...
              <section id="what-is-br-x402" className="subsubsection">
                <h3 className="subsubsection-title">What is <span className="brand-name">GATEX402</span>?</h3>
            ...
            <section id="core-concepts" className="subsection">
              ...
              <section id="br-x402-ecosystem" className="subsubsection">
                <h3 className="subsubsection-title">The <span className="brand-name">GATEX402</span> Ecosystem</h3>
                <p className="section-text">
            ...
            <section id="getting-access" className="subsection">
              ...
              <section id="accessing-br-x402-tools" className="subsubsection">
                <h3 className="subsubsection-title">Accessing <span className="brand-name">GATEX402</span> Tools</h3>
                <p className="section-text">
                  Access to the <span className="brand-name">GATEX402</span> Extension and API keys is currently managed via the <span className="brand-name">GATEX402</span> Dashboard. 
          ...
          <section id="user-guide" className="docs-section">
            ...
            <section id="the-extension" className="subsection">
              ...
              <section id="introduction-to-extension" className="subsubsection">
                ...
                <p className="section-text">
                  The <span className="brand-name">GATEX402</span> Extension is a powerful browser add-on that acts as your primary X402 wallet and interaction tool. 
            ...
            <section id="quick-start" className="subsection">
              ...
              <section id="generating-instant-payment-link" className="subsubsection">
                ...
                <ol className="feature-list">
                  <li className="feature-list-item">Click the <span className="brand-name">GATEX402</span> icon in your browser toolbar.</li>
            ...
            <section id="core-features" className="subsection">
              ...
              <section id="using-drag-drop" className="subsubsection">
                ...
                <p className="section-text">
                  <span className="brand-name">GATEX402</span>'s most powerful feature.
                </p>
                <p className="section-text">
...
{`Authorization: Bearer sk_test_YOUR_SECRET_KEY`}
            ...
            <section id="sdk-javascript" className="subsection">
              ...
              <section id="sdk-quick-start" className="subsubsection">
                ...
                <p className="section-text">
                  The <span className="brand-name">GATEX402</span> JavaScript SDK provides the simplest way to create front-end payment experiences. 
...
const x402 = GATEX402('pk_test_YOUR_PUBLIC_KEY');
            ...
            <section id="webhooks" className="subsection">
              ...
              <section id="handling-webhook-events" className="subsubsection">
                ...
                <p className="section-text">
                  ...
                  in your <span className="brand-name">GATEX402</span> Dashboard. Our server will send a POST request to your URL when an event occurs.
                </p>
              </section>
              ...
              <section id="securing-webhook-endpoint" className="subsubsection">
                ...
                <p className="section-text">
                  It is critical to verify that incoming webhooks are from <span className="brand-name">GATEX402</span>. Every request includes a 
                  <code className="code-inline">X-<span className="brand-name">GATEX402</span>-Signature</code> header. You must verify this signature using your Webhook Signing Secret 
